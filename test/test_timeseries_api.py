...
from crowdemotion_api_client_python.apis.timeseries_api import TimeseriesApi
...
class TestTimeseriesApi(unittest.TestCase):
    ...
    def setUp(self):
        self.api = crowdemotion_api_client_python.apis.timeseries_api.TimeseriesApi()
    ...
    def test_timeseries_delete(self):
        """
        Test case for timeseries_delete
